...
const isNotContainsStrict = (regexp) => complement(test(regexp));

const isContainsNoStrict = (regexp, replaceFn) => compose(test(regexp), replaceFn);
const isNotContainsNoStrict = (regexp, replaceFn) => complement(isContainsNoStrict(regexp, replaceFn));

// 1. Длина < 5 и кол-во цифр > 2 шт.
export const validateFieldN1 = (value) => {
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthMore(2));
...
export const validateFieldN2 = (value) => {
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthLess(2));
    const isLengthValid = getLengthValidatePredicate(isLengthLess(5));
    return allPass([isLengthValid, isNumCountValid])(value);
};
...
export const validateFieldN3 = (value) => {
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthMore(1));
...
export const validateFieldN4 = (value) => {
    ...
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthMore(2));
    return allPass([isLengthValid, isNumCountValid, isContainsNoStrict(/4/, replaceNotNumbers)])(value);
};
...
export const validateFieldN5 = (value) => {
    const isLengthValid = getLengthValidatePredicate(isLengthLess(10));
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthMore(1));
    return allPass([isLengthValid, isNumCountValid, isNotContainsNoStrict(/4/g, replaceNotNumbers)])(value);
};

// 6. Длина > 5, или одна из цифр равна "7"
export const validateFieldN6 = (value) => {
    const isLengthValid = getLengthValidatePredicate(isLengthMore(5));
    const contains7 = isContainsNoStrict(/7/, replaceNotNumbers);
...
export const validateFieldN7 = (value) => {
    ...
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthMore(3));
    const onlyEng = isNotContainsNoStrict(/[^A-Za-z]/g, replaceNumbers);
...
export const validateFieldN8 = (value) => {
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthLess(5));
    const onlyEng = isNotContainsStrict(/[^A-Za-z]/g);
    const contains7 = isContainsNoStrict(/7/, replaceNotNumbers);
...
export const validateFieldN9 = (value) => {
    ...
    const isNumCountValid = getNumbersCountValidatePredicate(isLengthMore(4));
    const onlyEng = isNotContainsNoStrict(/[^A-Za-z]/g, replaceNumbers);
